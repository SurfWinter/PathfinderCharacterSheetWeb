...
export const ITEM_LIBRARY = [
...

  {
    ...
    desc: 'Искатели приключений, которые не носят броню, путешествуют в крепкой одежде. Эта одежда — не броня и использует умение в защите без брони, но у неё также есть ограничение максимального модификатора Ловкости, и на ней можно начертать руны усиления (см. «Основную книгу ведущего»), чтобы получить бонус предмета к КБ.',
    armor: {
      ac: '+0',
      dexCap: '+5',
      group: 'Тканевая',
      armorCategory: 'Без брони',
      speedPenalty: null,
      strength: null,
    },
  },
